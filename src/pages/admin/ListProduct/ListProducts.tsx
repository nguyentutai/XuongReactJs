    ...
    return (
        <div className="container">
            <div className="flex justify-between items-center">
                ...
                <div>
                    <input type="search" className='block p-2 text-sm w-[300px] text-gray-900 border outline-none focus:border-gray-300 border-gray-300 rounded-lg bg-gray-50' onChange={e => setValue(e.target.value)} placeholder='Tìm kiếm sản phẩm ...' />
                </div>
            </div>
